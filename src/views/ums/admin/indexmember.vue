    ...
    <el-dialog
      ...
      <el-form :model="member"
        ...
        <el-form-item label="密码：">
          <el-input v-model="member.password"  type="password" style="width: 250px"></el-input>
        </el-form-item>
...
<script>
  import {fetchList,createAdmin,updateMember,updatmemberStatus,deleteAdmin,getRoleByAdmin,allocRole} from '@/api/usumember';
    ...
    methods: {
      ...
      handleStatusChange(index, row) {
        this.$confirm('是否要修改该状态?', '提示', {
          ...
          updatmemberStatus(row.id, {status: row.status}).then(response => {
            this.$message({
              type: 'success',
              message: '修改成功!'
            });
