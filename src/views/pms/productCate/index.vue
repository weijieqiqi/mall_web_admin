       ...
       <!--  <el-table-column label="是否显示" width="100" align="center">
        ...
        <el-table-column label="设置" width="200" align="center">
          <template slot-scope="scope">
            ...
            <!-- <el-button
              上面是调用了过滤器，调用了disableNextLevel这个方法
              size="mini"
...
// 把所有的ajax请求 都统一封装
  ...
  export default {
    ...
    watch: {
      $route(route) {
        this.resetParentId();//获取id再getList
        this.getList();
      }
    },
    methods: {
      //this.$route.query跳转传递参数
      resetParentId(){//二级分类
      ...
      getList() {
        ...
        fetchList(this.parentId, this.listQuery).then(response => {//调用我们封装在js文件中的方法，这里是fetchList
